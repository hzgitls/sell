...
public class PayServiceImpl implements PayService {
    ...
    private static final String OPEN_ID= "oOQ6T5z0SNB5Ruc9XyirKMo39t-U";
    @Autowired
    ...
    public PayResponse notify(String notifyData) {
        ...
        log.info("[微信支付] 异步通知 notifyData={},payResponse={}",notifyData,JsonUtil.toJson(payResponse));
        //查询订单
        ...
        if (!MathUtil.equals(payResponse.getOrderAmount(),orderDTO.getOrderAmount().doubleValue())){
            ...
            throw new SellException(ResultEnum.WXPAY_NOTIFY_MUNEY_VERIFY_ERROR);
        }
